    ...
    let types = pdb_info
        ...
        .map(|(index, type_ref)| {
            ...
            let (kind, name, size) = match &*borrowed {
                ...
                ezpdb::type_info::Type::MemberFunction(_) => ("MemberFunction".to_string(), None, None),
                ...
                ezpdb::type_info::Type::FieldList(_) => ("FieldList".to_string(), None, None),
                ezpdb::type_info::Type::ArgumentList(_) => ("ArgumentList".to_string(), None, None),
                ezpdb::type_info::Type::MethodList(_) => ("MethodList".to_string(), None, None),
                ...
                ezpdb::type_info::Type::BuildInfoType(_) => ("BuildInfoType".to_string(), None, None),
                ezpdb::type_info::Type::UdtSrcLineType(_) => ("UdtSrcLineType".to_string(), None, None),
            };
